  ...
  return (
    <main className="p-5 pt-[100px] bg-gray-50 min-h-[100vh] ">
      ...
      <div className="flex gap-4 flex-wrap max-w-[1300px] mx-auto items-center justify-center py-6">
        ...
        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 flex items-center justify-center min-w-[400px] h-[200px] bg-white shadow border rounded-md p-5 cursor-pointer hover:-rotate-6 hover:scale-105 transition-200 transition ">
